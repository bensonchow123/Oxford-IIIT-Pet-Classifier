...
class OxfordPetClassifierCNN(nn.Module):
    def __init__(self, num_classes=37):
        ...
        self.classifier = nn.Sequential(
            ...
            nn.Linear(768, num_classes) # map the 1024 features to 37 breed scores
        )
...
# this is needed for it to work on windows
if __name__ == "__main__":
    # changed so it will work with the .pth file in the zip file
    model_save_path = "pet_classifier_weights.pth"

    # Just in case the gpus in the cse/270 not work
    ...
    # load the testing set, changed to . so it will work for the submission bash script
    raw_test_data = datasets.OxfordIIITPet(root=".", split='test', download=True)
